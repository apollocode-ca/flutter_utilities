...
class ThemeProvider {
  final _appBarThemeProvider = AppBarThemeProvider();
  final _bannerThemeProvider = BannerThemeProvider();
  final _bottomAppBarThemeProvider = BottomAppBarThemeProvider();
  final _bottomNavigationBarThemeProvider = BottomNavigationBarThemeProvider();
  final _bottomSheetThemeProvider = BottomSheetThemeProvider();
  final _buttonBarThemeProvider = ButtonBarThemeProvider();
  final _cardThemeProvider = CardThemeProvider();
  final _checkboxThemeProvider = CheckboxThemeProvider();
  final _chipThemeProvider = ChipThemeProvider();
  final _colorSchemeProvider = ColorSchemeProvider();
  final _dataTableThemeProvider = DataTableThemeProvider();
  final _dialogThemeProvider = DialogThemeProvider();
  final _dividerThemeProvider = DividerThemeProvider();
  final _drawerThemeProvider = DrawerThemeProvider();
  final _elevatedButtonThemeProvider = ElevatedButtonThemeProvider();
  final _expansionTileThemeProvider = ExpansionTileThemeProvider();
  final _floatingActionButtonThemeProvider =
  ...
  final _listTileThemeProvider = ListTileThemeProvider();
  final _navigationBarThemeProvider = NavigationBarThemeProvider();
  final _navigationRailThemeProvider = NavigationRailThemeProvider();
  final _outlinedButtonThemeProvider = OutlinedButtonThemeProvider();
  final _popupMenuThemeProvider = PopupMenuThemeProvider();
  final _progressIndicatorThemeProvider = ProgressIndicatorThemeProvider();
  final _radioButtonThemeProvider = RadioButtonThemeProvider();
  final _scrollbarThemeProvider = ScrollbarThemeProvider();
  final _sliderThemeProvider = SliderThemeProvider();
  final _snackBarThemeProvider = SnackBarThemeProvider();
  final _switchThemeProvider = SwitchThemeProvider();
  final _tabBarThemeProvider = TabBarThemeProvider();
  final _textButtonThemeProvider = TextButtonThemeProvider();
  final _textSelectionThemeProvider = TextSelectionThemeProvider();
  final _timePickerThemeProvider = TimePickerThemeProvider();
  final _toggleButtonsThemeProvider = ToggleButtonsThemeProvider();
  final _tooltipThemeProvider = TooltipThemeProvider();
  ...
  ThemeData getFrom(Brightness brightness) {
    ...
    return ThemeData(
      ...
      buttonBarTheme: _buttonBarThemeProvider.theme,
